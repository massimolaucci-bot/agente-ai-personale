...
def build_api_messages(history, knowledge_text, history_limit=None, char_limit=None, location_text=None, current_user_name=None, documenti_correnti=None):
    ...
    system_prompt += (
        ...
        "REALE che devi descrivere con esattezza): quando l'utente dice 'aggiungila alle mie preferite' su una "
        "ricetta appena proposta, viene salvata per SEMPRE in un archivio reale del database - NON solo nella "
        "memoria di questa conversazione, resta anche dopo che la chat si azzera o Render riavvia il servizio - "
        "organizzato davvero per categoria (antipasto, primo, secondo, dessert, contorno, colazione...) presa "
